...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .cat-konsisten .category-header {
            color: var(--green-text);
        }

        .cat-sering .category-header {
            color: var(--blue-text);
        }

        .cat-kadang .category-header {
            color: var(--amber-text);
        }

        .cat-belum .category-header {
            color: var(--red-text);
        }
        ...
        .cat-konsisten .category-badge {
            background: rgba(16, 185, 129, 0.25);
            color: var(--green-text);
        }

        .cat-sering .category-badge {
            background: rgba(59, 130, 246, 0.25);
            color: var(--blue-text);
        }

        .cat-kadang .category-badge {
            background: rgba(245, 158, 11, 0.25);
            color: var(--amber-text);
        }

        .cat-belum .category-badge {
        ...
        .cat-konsisten .student-item input:checked {
            background: var(--green-accent);
        }

        .cat-sering .student-item input:checked {
            background: var(--blue-accent);
        }

        .cat-kadang .student-item input:checked {
            background: var(--amber-accent);
        }

        .cat-belum .student-item input:checked {
        ...
        .summary-cat.sc-konsisten {
            border-color: var(--green-border);
            background: var(--green-bg);
        }

        .summary-cat.sc-sering {
            border-color: var(--blue-border);
            background: var(--blue-bg);
        }

        .summary-cat.sc-kadang {
            border-color: var(--amber-border);
            background: var(--amber-bg);
        }

        .summary-cat.sc-belum {
            border-color: var(--red-border);
            background: var(--red-bg);
        }
        ...
        .sc-konsisten .summary-cat-title {
            color: var(--green-text);
        }

        .sc-sering .summary-cat-title {
            color: var(--blue-text);
        }

        .sc-kadang .summary-cat-title {
            color: var(--amber-text);
        }

        .sc-belum .summary-cat-title {
            color: var(--red-text);
        }
        ...
        .payload-body pre::-webkit-scrollbar {
            width: 4px;
        }

        .payload-body pre::-webkit-scrollbar-thumb {
            background: rgba(255, 255, 255, 0.1);
            border-radius: 2px;
        }
